...
public class History extends javax.swing.JPanel {
    ...
    String myID;
    String IP;
    public History(String myID, String IP) {
        initComponents();
        this.myID=myID;
        this.IP=IP;
       loadData();
    ...
    private void initComponents() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(40, 80, 67, 47);
...
//            
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        historyList.setCellRenderer(new PurchasedItemPanel());
   ...
   DefaultListModel<PurchasedItemObject> Items= new DefaultListModel<PurchasedItemObject>();
    String[] ShopName;
      String[] searchItem;
      String[] ItemName;
      String[] ItemQuantity;
    ...
    public void loadData()
    {
        ...
        ResultSet rs;
         try
            ...
            String sql="Select * from Purchased Where CMS_ID='"+myID+"'";
             st=con.createStatement();
    ...
    public void AddItems(ResultSet rs)
   {
       ...
       searchItem=new String[noOfItems];
        ...
        searchedShopName= new String[noOfItems];
       ...
       while(rs.next())
       {
           Items.addElement(new PurchasedItemObject(rs.getString("Item_Name"),rs.getInt("Quantity"),rs.getInt("Price"),rs.getString("Shop_Name"),rs.getDate("Purchase_Date").toString()));
           searchItem[ItemIndex]=rs.getString("Item_Name")+" "+Integer.toString(rs.getInt("Quantity"))+" "+Integer.toString(rs.getInt("Price"))+" "+rs.getString("Shop_Name")+" "+rs.getDate("Purchase_Date").toString();
        ...
        ShopName[ItemIndex]=rs.getString("Shop_Name");
       ...
       public void searchAddItem(int index)//int noOfFilteredItem, int[] filteredIndexes, String[] ItemName, String[] ItemPrice, String[] ItemQuantity)
    {
        ...
        searchedItemPrice[makeIndex]=ItemPrice[index];
         ...
         searchedShopName[makeIndex]=ShopName[index];
         searchedItemDate[makeIndex]=ItemDate[index];
        Items.addElement(new PurchasedItemObject(ItemName[index],Integer.parseInt(ItemQuantity[index]),Integer.parseInt(ItemPrice[index]),ShopName[index],ItemDate[index]));
        makeIndex++;
    } 
