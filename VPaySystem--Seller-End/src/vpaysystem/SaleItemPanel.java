 ...
 * @author SWHB
 */
public class SaleItemPanel extends javax.swing.JPanel implements ListCellRenderer<SaleItemObject>{

    /**
     * Creates new form ItemPanel
     */
    public SaleItemPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblCustomerName.setText("Syed Waqar Haider Bukhari");
        panel.add(lblCustomerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, 290, 30));
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends SaleItemObject> jlist, SaleItemObject e, int i, boolean bln, boolean bln1) {
        ...
        this.lblCustomerName.setText(e.CustomerName);
