 ...
 * @author SWHB
 */
public class HistoryforSeller extends javax.swing.JPanel {
    ...
    String myID;
    String IP;
    public HistoryforSeller(String myID, String IP) {
        initComponents();
        this.myID=myID;
        this.IP=IP;
       loadData();
...
//            
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        historyList.setCellRenderer(new HistoryItemPanel());
   ...
   DefaultListModel<HistoryItemObject> Items= new DefaultListModel<HistoryItemObject>();
    String[] Sender;
      String[] searchItem;
      String[] Reciever;
      int[] amount;
    ...
    public void loadData()
    {
        ...
        ResultSet rs;
         try
            ...
            String sql="Select * from AdminTransaction Where Sender_ID='"+myID+"' or Reciever_ID='"+myID+"'";
             st=con.createStatement();
    ...
    public void AddItems(ResultSet rs)
   {
       ...
       while(rs.next())
       {
           ...
           {
           Items.addElement(new HistoryItemObject("Admin","You",rs.getInt("Amount"),rs.getDate("Transfered_Date").toString()));
           
           searchItem[ItemIndex]="You Admin "+Integer.toString(rs.getInt("Amount"))+" "+rs.getDate("Transfered_Date").toString();
        Reciever[ItemIndex]="Admin";
        ...
        ItemDate[ItemIndex]=rs.getDate("Transfered_Date").toString();
           ...
           {
                Items.addElement(new HistoryItemObject("You","Admin",rs.getInt("Amount"),rs.getDate("Transfered_Date").toString()));
           
           searchItem[ItemIndex]="Admin You "+Integer.toString(rs.getInt("Amount"))+" "+rs.getDate("Transfered_Date").toString();
        Reciever[ItemIndex]="You";
        amount[ItemIndex]=rs.getInt("Amount");
      
        Sender[ItemIndex]="Admin";
        ItemDate[ItemIndex]=rs.getDate("Transfered_Date").toString();
           }
        ItemIndex++;
       }
       ...
       public void searchAddItem(int index)//int noOfFilteredItem, int[] filteredIndexes, String[] ItemName, String[] ItemPrice, String[] ItemQuantity)
    {
        ...
        Items.addElement(new HistoryItemObject(Reciever[index],Sender[index],amount[index],ItemDate[index]));
        makeIndex++;
    } 
